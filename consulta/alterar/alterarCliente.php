...
<html>
	...
	<?php
	 ...
	 ?>
		<form action="./confirmarAlterar/confirmarAlterarCliente.php" method="POST">
				...
				<div class="row">
    				...
    				<div class="col">
      					<div class="mb-3">
							...
							<input type="text" class="form-control" name="nome" value="<?php echo $row['nm_cliente'];?>" required>
							
							<label for="cCPF"><b>CPF</b></label>
							<input type="text" placeholder="CPF do Cliente" class="form-control" name="cpf" required maxlength="11" value="<?php echo $row['cd_cpf'];?>"
							onkeypress='return event.charCode >= 48 && event.charCode <= 57'  
							onblur="TestaCPF(this.value);">
							
							<label for="cRG"><b>RG</b></label>
							<input type="text" placeholder="RG do Cliente" class="form-control" name="rg" value="<?php echo $row['cd_rg'];?>" required>
							
							<label for="cCEP"><b>CEP</b></label>
							<input type="text" placeholder="CEP do Cliente" id="cep" class="form-control" name="cep" value="<?php echo $row['cd_cep'];?>"
							...
							<input type="text" placeholder="Telefone do Cliente" class="form-control" name="telefone" value="<?php echo $row['cd_telefone'];?>"  required>

							<label for="cCel"><b>Celular</b></label>
							<input type="text" placeholder="Celular do Cliente" class="form-control" name="celular" value="<?php echo $row['cd_celular'];?>"  required>
